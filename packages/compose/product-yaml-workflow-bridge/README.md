# @rayspec/product-yaml-workflow-bridge

The bridge from Product-YAML workflow declarations to the durable workflow engine:
compiler, loader, and inventory that turn declared workflows into executable definitions.
