...
The first HTTP server composition: the Hono `OpenAPIHono` app factory plus the
`@rayspec/auth-core` services it composes. The public surface is the app factory and
those auth services.
