# @rayspec/adapter-deepgram

The Deepgram speech-to-text provider adapter. Implements the provider-neutral STT port
(`@rayspec/stt-port`: `SttAdapter` contract, transcript types, registry,
media-resolver, normalizer) against the Deepgram API.
