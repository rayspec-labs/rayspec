...
const CITATIONS: ReadonlyArray<readonly [string, string]> = [
  ...
  ['packages/app/server/src/workforce-turn-handlers.ts:155', 'buildRoleToolset'],
  ['packages/app/server/src/workforce-turn-handlers.ts:203', 'memory.search'],
  ['packages/app/server/src/workforce-turn-handlers.ts:73', 'memoryProviderFor'],
  ['packages/app/server/src/composition-root.ts:3553', 'orchestrationStrategy'],
  ['packages/app/server/src/composition-root.ts:3540', 'buildWorkforceTurnHandlers'],
  ...
  ['packages/kernel/workforce-tools/src/context.ts:700-701', 'const elastic:'],
  ['packages/kernel/workforce-tools/src/context.ts:645', 'SEAM_MAX_MEMORY_HITS'],
  ['packages/kernel/workforce-tools/src/memory.ts:39', 'RECALL_MAX_HITS = 10'],
