...
const CITATIONS: ReadonlyArray<readonly [string, string]> = [
  ...
  ['packages/kernel/workforce-tools/src/toolset.ts:919', 'TOOLSETS_BY_ROLE['],
  ['packages/app/server/src/workforce-turn-handlers.ts:140', 'buildRoleToolset'],
  ['packages/app/server/src/workforce-turn-handlers.ts:188', 'memory.search'],
  ['packages/app/server/src/workforce-turn-handlers.ts:74', 'memoryProviderFor'],
  ...
  ['packages/kernel/workforce-tools/src/context.ts:707-708', 'const elastic:'],
  ['packages/kernel/workforce-tools/src/context.ts:652', 'SEAM_MAX_MEMORY_HITS'],
  ...
  ['packages/kernel/workforce-tools/src/review-policy.ts:98', 'DeclaredReviewPolicy'],
