...
//
// Duplicated verbatim in @rayspec/durable-dbos `claim-pause-ordering.test.ts` and @rayspec/server
// `intake-pause-ordering.test.ts`: the three guards live in three packages with no shared
// test-utility package between them, and each copy carries its OWN battery, so a copy that drifts
// reddens in its own lane rather than relying on a parity check nobody runs.
// ─────────────────────────────────────────────────────────────────────────────────────────────
