 ...
 * the durable run on (`file_id:<id>` — the S3 generic format; the `:finalized` suffix stays
...
/** The neutral workflow trigger event id a file submit maps onto (the S1 default join). */
