# @rayspec/agent-runtime

The workflow **agent node**: runs an agent step inside a durable workflow, resolving the
configured backend adapter and handler registry, with fakes provided for deterministic
tests.
