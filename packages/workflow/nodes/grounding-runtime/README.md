# @rayspec/grounding-runtime

Grounding and artifact nodes for durable workflows: the artifact-store seam plus
grounding checks (e.g. quote verification) that tie agent output back to its source
material.
