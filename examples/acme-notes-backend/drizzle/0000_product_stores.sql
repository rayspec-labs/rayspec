...
--> statement-breakpoint
CREATE UNIQUE INDEX "notebooks_idempotency_key_unique" ON "notebooks" USING btree ("tenant_id", "idempotency_key");
--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX "entries_idempotency_key_unique" ON "entries" USING btree ("tenant_id", "idempotency_key");
--> statement-breakpoint
